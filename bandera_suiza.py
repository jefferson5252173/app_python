...
frame_azul.config(bg="white", width=300, height=100)
frame_azul.place(x=100, y=200)

#---------------
# frama blanca
#---------------
frame_azul = Frame(ventana_principal)
frame_azul.config(bg="white", width=100, height=300)
frame_azul.place(x=200, y=100 )
